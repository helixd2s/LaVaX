...
namespace lvx {
    ...
    VkResult VkDescriptorSetLayout_T::Create(const lvx::VkDevice_T* device, HPTR(VkDescriptorSetLayoutCreateInfo) createInfo, UPTR(VkAllocationCallbacks) callbacks) {
